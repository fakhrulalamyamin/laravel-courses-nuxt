    ...
    <div class="container mx-auto">
      ...
      <div class="flex mt-8">
        <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
          ...
          <div class="rounded-sm mt-8 shadow-sm">
            <img
              ...
              src="https://laravel-courses.com/storage/courses/392a17fb-7b83-4663-a75f-82bcb0a23519.png"
              alt="Testing Laravel"
            />
            <div class="py-6">
              <div
                class="text-base space-y-6 font-normal text-gray-700 line-clamp-20"
              >
                <p>
                  Numquam iusto facilis et eaque. Optio et aut dolorum eveniet.
                  Id dolorem aut corporis sed omnis voluptatem. Id perspiciatis
                  optio illo libero. Quia et nihil magni enim aut. Quidem
                  voluptas et vel adipisci et. Voluptas harum sit velit quo.
                  Maiores nihil vel quia sint molestiae quibusdam. Quaerat
                  dolores consequatur consequatur animi placeat.
                </p>
              </div>
            </div>
          </div>
            ...
            <li class="bg-white rounded-sm shadow">
              <div class="px-6 py-5">
                ...
                <div class="flex items-center mt-5 sm:mt-8">
                  <img
                    class="flex-shrink-0 w-6 h-6 bg-gray-300 rounded-full"
        ...
        <div class="w-1/3 pl-10 pt-0">
          ...
          <!--Author Section-->
          <div
            class="overflow-hidden bg-white border border-gray-200 rounded-sm shadow-sm"
          >
            <div class="space-y-4 p-6">
              ...
              <div class="space-y-4 pb-2">
                ...
                <!--Author Name-->
                <div
                  class="space-y-1 text-lg font-medium leading-6 text-center"
                >
                ...
                <ul role="list" class="flex space-x-5 justify-center">
                  ...
                  <li>
                    <a
                      href="https://github.com/freekmurze"
                      class="text-gray-400 hover:text-gray-500"
                      target="_blank"
                    >
                ...
                <div class="text-sm px-7">
                  <p class="text-gray-500">
                    I'm a PHP developer and Laravel enthusiast. Most of my time
                    is spent at Spatie of which I'm the co-owner. Whenever my
                    colleagues and I stumble upon a problem that we can solve in
                    a clean way, we extract our solution so other developers can
                    use it. Together with my colleagues I regularly release
                    packages that have been downloaded more than 500 million
                    times.
                  </p>
                </div>
              </div>
          ...
          <!--Topci Filter-->
          <div
            class="overflow-hidden bg-white border border-gray-200 rounded-sm mt-6 shadow-sm"
          >
...
const course = await $fetch(
  `${process.env.BASE_URL}/course/${route.params.slug}`
);
</script>
